...
Thank you for your purchase. This is a short getting-started file, a complete documentation for the theme is located in `html/docs` folder or [online](https://demo.bootstrapious.com/bubbly/1-0/docs/introduction.html).
...
See more about the [Gulp workflow](https://demo.bootstrapious.com/bubbly/1-0/docs/gulp.html) and [customizing the SCSS](https://demo.bootstrapious.com/bubbly/1-0/docs/customizing-css.html). 
